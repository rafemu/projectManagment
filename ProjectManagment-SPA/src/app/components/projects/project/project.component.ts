...
export class ProjectComponent implements OnInit {
  ...
  constructor(private recordsService: RecordsService,private projectService:ProjectsService,
  ...
  ngOnInit(): void {
   ...
   this.subscribtionProject = this.projectService.projectById$.pipe(untilDestroyed(this)).subscribe((project)=>{
    this.project = project.project
   })
  this.subscribtionRecords= this.recordsService.recordsByProject$.pipe(untilDestroyed(this)).subscribe(record=>{
